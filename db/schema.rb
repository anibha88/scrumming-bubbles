...
ActiveRecord::Schema.define(version: 20160516091006) do
  ...
  add_index "listings", ["project_id"], name: "index_listings_on_project_id", using: :btree
  ...
  add_foreign_key "listings", "projects"
